...
class CreateAttachment(core.Construct):
  def __init__(self, scope:core.Construct, id:str, owner:LandingZone,peer:LandingZone,**kwargs):
    ...
    peer_gateway_id = ParameterReader(self, 'PeerGatewayId',
      props=ParameterReaderProps(
        parameterName='/homenet/{}/transit-gateway/gateway-id'.format(peer_region),
        region= peer_region))
    ...
    self.resource = cr.AwsCustomResource(self,'Peering',
      ...
      on_create=cr.AwsSdkCall(
        ...
        parameters={
          ...
          'PeerTransitGatewayId':peer_gateway_id.value,
  ...
  def attachment_id(self)->str:
    return self.resource.get_response_field('TransitGatewayPeeringAttachment.TransitGatewayAttachmentId')
