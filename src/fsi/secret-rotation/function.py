...
def lambda_handler(event:dict, context:dict):
    ...
    # Setup the client
    service_client = boto3.client('secretsmanager', region_name=os.environ.get('REGION')) #endpoint_url=os.environ['SECRETS_MANAGER_ENDPOINT'])
...
def create_secret(service_client, arn, token):
    ...
    try:
        ...
        with open(client.credentials_path.absolute(),'r') as f:
          new_secret = f.read()
